...
<a class="navbar-brand brand-logo" href="index.html">Trade 360</a>
<a class="navbar-brand brand-logo-mini" href="index.html">Trade 360</a>
</div>
<ul class="navbar-nav navbar-nav-right">
<li class="nav-item dropdown  d-lg-flex d-none">
<a href = "{{ route('profile') }}"><button type="button" class="btn btn-inverse-primary btn-sm">Back To Home</button></a>
</li>
<li class="nav-item dropdown d-lg-flex d-none">
<button type="button" class="btn btn-inverse-primary btn-sm">Create Post</button>
</li>
...
<span class="menu-title">{{ trans('forum::general.index') }}</span>
</a>     
</li>
<li class="nav-item ">
<a class = "nav-link" href = "{{ route('forum.recent') }}">
<p class = "menu-icon"></p>
<span class="menu-title">{{ trans('forum::threads.recent') }}</span>
</a> 
</li>
<li class="nav-item">
@auth
<a href="{{ route('forum.unread') }}" class="nav-link ">
<p class = "menu-icon"></p>
<span class="menu-title">{{ trans('forum::threads.unread_updated') }}</span>
</a>
@endauth
</li>
<li class="nav-item">
@can('moveCategories')
<a href="{{ route('forum.category.manage') }}" class="nav-link">
<p class = "menu-icon"></p>
<span class="menu-title">{{ trans('forum::general.manage') }}</span>                    
</a>
@endcan
</li>
</ul>
...
<div id="main" class="container">
    ...
    <!--<nav class="v-navbar navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url(config('forum.web.router.prefix')) }}">Trade 360 Forum</a>
